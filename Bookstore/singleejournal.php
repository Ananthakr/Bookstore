...
if ($conn->connect_error) {
    die("Connection failed: " . $conn->connect_error);
        ...
        $ct=0;$tot=0;}
        $id=$_GET['id'];
        $sql="SELECT * from ejourn where ej_id=$id";
        $result=$conn->query($sql);
        while($row = $result->fetch_assoc()) {
        $name=$row['ej_name'];
        $pubid=$row['pub_id'];
       ...
       $sql = "SELECT pub_name FROM publisher where pub_id=$pubid";
          $result = $conn->query($sql);
        while($row = $result->fetch_assoc()) {
        $autname=$row['pub_name'];
        }
        ...
        $username = "root";
         ...
         // Create connection
          $conn = new mysqli($servername, $username, $password,$dbname);
             $sql = "SELECT ej_name FROM ejourn limit 4";
          $result = $conn->query($sql);
          $k=0;
        while($row = $result->fetch_assoc()) {
        $pro[$k]=$row['ej_name'];
                ...
                <div class="col-md-8">
                    <div class="product-content-right">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                    ...
                                    <form action="addtocart.php" method="post" class="cart">
                                       ...
                                       <a href="#"> <button class="add_to_cart_button" type="submit">Download</button></a>
                                    </form>   
                          ...
                          <?php
                                $a=related_products();
             $sql = "SELECT eb_id FROM ebooks limit 4";
          $result = $conn->query($sql);
          $k=0;
          while($row = $result->fetch_assoc()) {
                  $b[$k]=$row['eb_id'];
