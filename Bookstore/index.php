                        ...
                        <div class="product-carousel">
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="img/arise-awake.jpeg" alt="">
                                ...
                                <h2><a href="single-product.html">Arise, Awake</a></h2>
                                
                                <div class="product-carousel-price">
                                    <ins>$5.00</ins> <del>$8.00</del>
                                </div> 
                            </div>
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="img/A hundred summers.jpg" alt="">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="single-product.html" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
                                ...
                                <h2><a href="single-product.html">A Hundred Summers</a></h2>
                                <div class="product-carousel-price">
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="img/eat pray love.jpg" alt="">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="single-product.html" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
                                ...
                                <h2><a href="single-product.html">Eat Pray Love</a></h2>

                                <div class="product-carousel-price">
                                    <ins>$4.00</ins> <del>$4.75</del>
                                </div>                                 
                            </div>
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="img/scion of ikshvaku.jpg" alt="">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="single-product.html" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
                                ...
                                <h2><a href="single-product.html">Scion of Ikshvaku</a></h2>

                                <div class="product-carousel-price">
                                    <ins>$20.00</ins> <del>$22.00</del>
                                </div>                            
                            </div>
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="img/upsc.jpeg" alt="">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="single-product.html" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
                                ...
                                <h2><a href="single-product.html">UPSC-General studies</a></h2>

                                <div class="product-carousel-price">
                                    <ins>$12.00</ins> <del>$15.00</del>
                                </div>                                 
                            </div>
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="img/the innovators.jpg" alt="">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="single-product.html" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
                                ...
                                <h2><a href="single-product.html">The Innovators</a></h2>
                ...
                <div class="col-md-12">
                    <div class="brand-wrapper">
                        ...
                        <div class="brand-list">
                            ...
                            <img src="img/services_logo__4.png" alt="">
                            <img src="img/services_logo__1.jpg" alt="">
                            <img src="img/services_logo__2.jpg" alt="">
                            <img src="img/services_logo__3.jpg" alt="">
                            <img src="img/services_logo__4.png" alt="">                            
