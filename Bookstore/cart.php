...
if ($conn->connect_error) {
    die("Connection failed: " . $conn->connect_error);
        ...
        //getting cartid
          $sql = "SELECT cart_id,tot_price,discounts FROM cart_user where u_name='$uname'";
                                ...
                                <table cellspacing="0" class="shop_table cart">
                                    <thead>
                                        <tr>
                                            ...
                                            <!--th class="product-thumbnail">P</th-->
                                    ...
                                    <tbody>
                                        ...
                                        ?><tr class="cart_item">
                                            <td class="product-remove">
                                                <a title="Remove this item" class="remove" href="remove.php?bkid=<?php echo $bkid[$q]; echo "&cid="; echo $cartid;?>">×</a> 
                                            </td>
                                            ...
                                            <td class="product-name">
                                                <a href="getsingle.php?id=<?php  echo $bkid[$q];?>"><?php echo $bkna[$q];?></a> 
                                            </td>

                                            <td class="product-price">
                                                <span class="amount">$ <?php echo $pri[$q];?></span> 
                                            </td>

                                            <td class="product-quantity">
                                                <div class="quantity buttons_added">
                                                    <!--input type="button" class="minus" value="-"-->
                                                    <input type="number" size="4" class="input-text qty text" title="Qty" value="<?php echo $qt[$q];?>" min="0" step="1">
                                        ...
                                        ?>
                                            <td class="actions" colspan="6">
                                               ...
                                               <form action="shop.php"><input type="submit" value="Add More" name="addmore" class="button"></form>
                                               <br>
                                                <form action="checkout.php"><input type="submit" value="Proceed to Checkout" name="proceed" class="button"></form>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table cellspacing="0">
                                    <tbody>
                                        <tr class="cart-subtotal">
                                            <th>Cart Subtotal</th>
                                            <td><span class="amount">$ <?php echo $tot;?></span></td>
                                        </tr>
                                         <tr class="shipping">
                                            <th>Discounts</th>
                                            <td>$ <?php echo $dis; ?></td>
                                        ...
                                        <tr class="order-total">
                                            <th>Order Total</th>
                                            <td><strong><span class="amount">$ <?php echo $tot-$dis+5;?></span></strong> </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
