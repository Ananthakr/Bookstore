...
if ($conn->connect_error) {
    die("Connection failed: " . $conn->connect_error);
        ...
        $cartid=$row['cart_id'];$tot=$row['tot_price'];$dis=$row['discounts'];}
        //getting ct
                ...
                <div class="col-md-8">
                    <div class="product-content-right">
                        <div class="woocommerce">
                            <div class="woocommerce-info">Returning customer? <a class="showlogin" data-toggle="collapse" href="login.php" aria-expanded="false" aria-controls="login-form-wrap">Click here to login</a>
                            </div>
                            ...
                            <form enctype="multipart/form-data" action="order.php?price=<?php echo $tot;?>" class="checkout" method="post" name="checkout">

                                <div id="customer_details" class="col2-set">
                                    <div class="col-1">
                                        <div class="woocommerce-billing-fields">
                                            <h3>Billing Details</h3>
                                            <p id="billing_country_field" name="billing_country_field" class="form-row form-row-wide address-field update_totals_on_change validate-required woocommerce-validated">
                                            ...
                                            <p id="billing_name" name="billing_name_field" class="form-row form-row-first validate-required">
                                            ...
                                            <p id="billing_address_2_field" name="billing_address_2_field" class="form-row form-row-wide address-field">
                                            ...
                                            <p id="billing_city_field" name="billing_city_field" class="form-row form-row-wide address-field validate-required" data-o_class="form-row form-row-wide address-field validate-required">
                                            ...
                                            <p id="billing_state_field" name="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
                                            ...
                                            <p id="billing_pincode_field" name="billing_pincode_field" class="form-row form-row-last address-field validate-required validate-postcode" data-o_class="form-row form-row-last address-field validate-required validate-postcode">
                                            ...
                                            <p id="billing_email_field" name="billing_email_field" class="form-row form-row-first validate-required validate-email">
                                                <label class="" for="billing_email">Email Address <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="" placeholder="" id="billing_email" name="billing_email" class="input-text ">
                                            </p>

                                            <p id="billing_phone_field" name="billing_phone_field" class="form-row form-row-last validate-required validate-phone">
                        ...
                        <input type="checkbox" value="1" name="ship_to_different_address" checked="checked" class="input-checkbox" id="ship-to-different-address-checkbox">
                                            ...
                                            <div class="shipping_address" style="display: block;">
                                                <p id="shipping_country_field" name="shipping_country_field" class="form-row form-row-wide address-field update_totals_on_change validate-required woocommerce-validated">
                                                ...
                                                <p id="shipping_name_field" name="shipping_name_field" class="form-row form-row-first validate-required">
                                                ...
                                                <p id="shipping_address_1_field" name="shipping_address_1_field" class="form-row form-row-wide address-field validate-required">
                                                ...
                                                <p id="shipping_address_2_field" name="shipping_address_2_field" class="form-row form-row-wide address-field">
                                                ...
                                                <p id="shipping_city_field"  name="shipping_city_field" class="form-row form-row-wide address-field validate-required" data-o_class="form-row form-row-wide address-field validate-required">
                                                ...
                                                <p id="shipping_state_field" name="shipping_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
                                                ...
                                                <p id="shipping_postcode_field" name="shipping_postcode_field" class="form-row form-row-last address-field validate-required validate-postcode" data-o_class="form-row form-row-last address-field validate-required validate-postcode">
                                    ...
                                    <table class="shop_table">
                                        ...
                                        <tbody>
                                            <tr class="cart_item">
                                                ...
                                                <?php echo $bkna[$q]." x ";?><strong class="product-quantity"><?php echo $qt[$q];?></strong> </td>
                                                <td class="product-total">
                                                    <span class="amount">$ <?php echo $pri[$q];?></span> </td>
                                            </tr>
                                        </tbody>
                                        <?php }?>
                                        <tfoot>
                                            ...
                                            <tr class="cart-subtotal">
                                                <th>Cart Subtotal</th>
                                                <td><span class="amount">$<?php echo $tot;?></span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr class="order-total">
                                                <th>Order Total</th>
                                                <td><strong><span class="amount">$ <?php echo $tot+5?></span></strong> </td>
                                            </tr>
